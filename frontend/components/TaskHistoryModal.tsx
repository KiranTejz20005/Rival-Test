            ...
            <div className="relative border-l border-gray-200 dark:border-gray-800 ml-3 space-y-6">
              {logs.map((log) => (
                <div key={log.id} className="relative pl-6">
                  {/* Dot */}
                  <span className="absolute -left-2.5 top-1.5 flex items-center justify-center w-5 h-5 rounded-full ring-4 ring-white dark:ring-gray-900 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
